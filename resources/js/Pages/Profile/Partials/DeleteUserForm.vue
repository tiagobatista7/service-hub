  ...
  <section class="space-y-6">
    <header>
      ...
      <p class="mt-1 text-sm text-gray-600">
        ...
        permanentemente apagados. Antes de excluir sua conta, por favor faça o download de
        quaisquer dados ou informações que desejar manter.
      </p>
    </header>
    ...
    <Modal :show="confirmingUserDeletion" @close="closeModal">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
          Uma vez que sua conta for excluída, todos os seus recursos e dados serão
          permanentemente apagados. Por favor, insira sua senha para confirmar que deseja
